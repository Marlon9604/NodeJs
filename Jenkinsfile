...
pipeline {
  ...
  stage("Pushing to Azure Storage") {
     steps{
        ...
        sh 'az acr task create --registry docker202102 --name tareadocker --image marlon9604/prueba:30 --context https://github.com/Marlon9604/NodeJs.git#master --file Dockerfile --git-access-token 1954a057687f1574d5696bc6c8962abdc4f945bb'
 }
